...
const ReportFound = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("Submitting report to:", apiEndpoints.postFound);
      const response = await fetch(apiEndpoints.postFound, {
        method: "POST",
        body: formData,
        credentials: "include",
      });
      ...
      <div className="relative max-w-2xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className={isDark ? "text-white/60" : "text-gray-600"}>
            Fill in the details below to help owners find their belongings
          </p>
        </div>
          ...
          >
              ...
              <div key={field.name}>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className={`w-full px-5 py-4 pl-12 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-transparent transition-all ${
                      isDark
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full px-5 py-4 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-transparent transition-all resize-none ${
                  isDark
                    ? "bg-white/10 border-white/20 text-white placeholder-white/40"
                    : "bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400"
                }`}
                ...
                <div className="grid grid-cols-3 sm:grid-cols-5 gap-3 mb-4">
                  {photoPreviews.map((preview, index) => (
                    <div key={index} className="relative group">
                      ...
                      {index === 0 && (
                        <span className="absolute bottom-1 left-1 px-2 py-0.5 bg-emerald-500/80 rounded text-xs text-white">
                          Main
                        </span>
                      )}
                    </div>
              ...
              <div className="relative">
                ...
                <label
                  ...
                  className={`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-xl cursor-pointer transition-all ${
                    ...
                    isDark
                      ? "bg-white/10 border-white/20 hover:bg-white/15 hover:border-emerald-500/50"
                      : "bg-gray-50 border-gray-300 hover:bg-gray-100 hover:border-emerald-400"
                  }`}
                >
                  <svg
